...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=131qpho7Kky6_sR-fFQdtAo7_1KiFOiNLwSMVHgvpz7o#gid=0).
...
def read_my_google_doc():
    ...
    get_document('131qpho7Kky6_sR-fFQdtAo7_1KiFOiNLwSMVHgvpz7o', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/leadpipes/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|leadpipes|tweet|`location`||
|leadpipes|facebook|`location`||
|leadpipes|email|`location`||
|leadpipes|new-comment||
|leadpipes|open-share-discuss||
|leadpipes|close-share-discuss||
|leadpipes|summary-copied||
|leadpipes|featured-tweet-action|`action`|
|leadpipes|featured-facebook-action|`action`|
